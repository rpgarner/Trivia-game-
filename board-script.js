...
let football = [
  ...
  //question 2
  {
    points: 200,
    question:
      "Payton Manning missed all of the 2011 season, due to an injury to what body part?",
    correctAnswer: "a",
  ...
  //question 4
  {
    points: 400,
    question:
      "The triple crown is awarded to a player who had the most yards, touchdowns, receptions. Who was the last player to be reward the Triple crown?",
    correctAnswer: "b",
    answers: [
      "a: Randy Moss",
      "b: Cooper Kupp",
  ...
  // question 5
  {
    points: 500,
    question:
      "What team was established in 1898 and was the first team to join the NFL?",
    correctAnswer: "d",
    answers: [
...
let baseball = [
  ...
  //question 4
  {
    points: 400,
    question:
      "Barry Bonds has the record for the most Home Runs in a season, how many did he hit?",
    correctAnswer: "b",
...
let sportHistory = [
  ...
  //question 4
  {
    points: 400,
    question:
      "Micheal Jordan and the Chicago went on a incredible championship run, how many did they win ",
    correctAnswer: "c",
...
let olympics = [
  ...
  // question 4
  {
    points: 400,
    question:
      "What country that competed, went through the longest drought of winning a gold medal?",
    correctAnswer: "c",
    answers: [
      " a: Greece",
      " b: South Africa",
...
let almost = [
 // question 1 
    ...
    points: 100,
    question:
      "In track and feild what achievement was considered impossible to beat but after 1954 has been broken over 1,000 times?",
    correctAnswer: "a",
    answers: [
      " a: 4 minute mile",
      " b: 6 meter pull volt ",
  ...
  // question 2
  {
    points: 200,
    question:
      "What NFL team almost beat the undefeated season record but lost their last game",
    correctAnswer: "c",
    answers: [
      " a: Miami Dolphins ",
      " b: Dallas Cowboys",
  ...
  //question 3
  {
    points: 300,
    question:
      "what NFL team went to 4 superbowls in a row, but did not win a single one",
    correctAnswer: "b",
    answers: [
      " a: Dallas Cowboys",
      " b: Buffalo Bills",
  ...
  // question 4
  {
    points: 400,
    question:
      "What college footbal team had the worst losing record at 34 straight games?",
    correctAnswer: "d",
    answers: [
      " a: North Illinois",
      " b: UCLA",
  ...
  // question 5
  {
    points: 500,
    question:
      " What NFL player returned a funble 66 yards into the wrong endzone?",
    correctAnswer: "d",
    answers: [
      " a: Deion Sanders",
      " b: Trent Williams",
